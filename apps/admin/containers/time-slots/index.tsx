...
function TimeSlotsPageInner() {
    return (
        <div className="p-8">
            <h1 className="font-heading text-xl font-bold text-gray-900 mb-1">Khung giờ</h1>
            <p className="text-xs text-gray-500 mb-6">Demo — cấu hình khung giờ nhận booking sẽ hiển thị ở đây</p>
