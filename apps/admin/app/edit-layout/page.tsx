...
// Menu duy nhất "Chỉnh sửa layout trang booking" — chọn 1 trong 7 trang để vào
// Puck builder, chỉ load registry/component của đúng trang đó (BR-7/BR-8).
export default function EditLayoutIndexPage() {
  return (
    <div className="p-8">
